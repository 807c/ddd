    ...
    try:
        ...
        if local and local.combat_avatar:
            try:
                ...
                if _b._DH_ENFORCE_COUNTER < 0:
                    pass  # warmup — ne pas toucher aux weapon cases
                elif hasattr(_b, '_DH_GUN_SAVED') and _b._DH_GUN_SAVED and _b._DH_ENFORCE_COUNTER % 90 == 0:
