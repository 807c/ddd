...
def esp_tick(*args):
    ...
    try:
        ...
        # NO enforce loop — calling Change* from the tick thread races against
        # the game's weapon case lifecycle on pickup/swap = native crash.
        # Skins are applied only on explicit user action via the menu.
